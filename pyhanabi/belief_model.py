...
class ARBeliefModel(nn.Module):
    ...
    def loss(self, batch, beta=1):
        ...
        err = pred_loss(logp, gtruth, seq_len)
        ...
        v0_err = pred_loss(logv0, gtruth, seq_len)
        return err, v0_err
    ...
    def sample(self, o: torch.Tensor, num_sample: int) -> torch.Tensor:
        # o: [seq_len(1), dim]
        seq, hid_dim = o.size()
        ...
        return torch.stack(sample_list, 2)
